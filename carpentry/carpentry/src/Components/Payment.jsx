...
export default function Payment() {
  ...
  <Image src="https://ii2.pepperfry.com/media/wysiwyg/banners/Promo_a1_b1_c1_Web_VIPCoupon500_RepublicSale_2X_2001_ND.jpg" marginTop="20px" />
  </Container>
...
<Stack direction={{base:"column", md:"row"}} spacing={5}  >
   ...
   >
    ...
    <VStack>
     ...
     <Button style={{marginTop:"20px"}}  onClick={handlePayment} fontSize="x" padding={3} w="full" border="1px solid grey" > PAY  </Button>
